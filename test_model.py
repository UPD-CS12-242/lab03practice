...
from model import SubtractASquareModel, Feedback
...
class TestInit:
    ...
    def test_player_count_invalid(self):
        ...
        for player_count in invalid_player_counts:
            with pytest.raises(ValueError):
                SubtractASquareModel(2, player_count)
    ...
    def test_both_invalid(self):
        ...
        for n in invalid_ns:
            for player_count in invalid_player_counts:
                with pytest.raises(ValueError):
                    SubtractASquareModel(n, player_count)


class TestCurrentPlayer:
    def test_init_2(self):
        model = SubtractASquareModel(10, 2)
        assert model.current_player == 1

    def test_init_3(self):
        model = SubtractASquareModel(10, 3)
        assert model.current_player == 1

    def test_until_end_2(self):
        model = SubtractASquareModel(106, 2)
        assert model.current_player == 1
    ...
    def test_until_end_3(self):
        model = SubtractASquareModel(106, 3)
        assert model.current_player == 1
...
class TestN:
    ...
    def test_init_1(self):
        model = SubtractASquareModel(1, 2)
        assert model.n == 1


class TestSubtractSquare:
    def test_valid_16(self):
        model = SubtractASquareModel(100, 2)
    ...
    def test_valid_large(self):
        ...
        model = SubtractASquareModel(large_square + 1, 2)
    ...
    def test_invalid_large(self):
        ...
        model = SubtractASquareModel(large_nonsquare + 1, 2)
    ...
    def test_invalid_neg_square_large(self):
        ...
        model = SubtractASquareModel(large_square, 2)
